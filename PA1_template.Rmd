...
###Mean of steps taken each day : `r mean_totalSteps`  

###Median of steps taken each day : `r median_totalSteps`
...
### 5 minute interval with maximum number of steps: `r interval_maxstep`
...
###New Mean of steps taken each day : `r mean_totalSteps_n`  

###New Median of steps taken each day : `r median_totalSteps_n`
